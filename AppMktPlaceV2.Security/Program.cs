#region REFERENCES
using AppMktPlaceV2.Security.Application.Helper.Static.Serilog;
...
using AppMktPlaceV2.Security.Application.Helper.Static.Settings.Jtw;
using AppMktPlaceV2.Security.Domain.Context.SQLServer;
using AppMktPlaceV2.Security.Infrastructure.Arquiteture.ServicesInjection;
using AppMktPlaceV2.Security.Infrastructure.Mappers;
